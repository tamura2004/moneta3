products = [
  ...
  { name: "住宅ローン", currency: "JPY", rate: "5.0", is_debit: true, is_fixed: true, is_credit: false },
  { name: "学資ローン", currency: "JPY", rate: "2.0", is_debit: true, is_fixed: true, is_credit: false },
  { name: "フリーローン", currency: "JPY", rate: "5.0", is_debit: true, is_fixed: false, is_credit: false },
  { name: "クレジットカード", currency: "JPY", rate: "15.0", is_debit: true, is_fixed: false, is_credit: true },
]
